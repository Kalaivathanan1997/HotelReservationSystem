                    ...
                    <div class="booking-inner clearfix ">
                        <form class="form1 clearfix">
                            <div class="col11 c1">
                                <div class="input1_wrapper">
                                    ...
                                    <div class="input1_inner">
                                        <input type="text" id="check_in"  name="check_in" class="form-control input datepicker" placeholder="Check in" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col11 c2">
                                <div class="input1_wrapper">
                                    ...
                                    <div class="input1_inner">
                                        <input type="text" id="check_out" name="check_out" class="form-control input datepicker"  placeholder="Check out" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col21 c3">
                            ...
                            <a href="#" id="roomBooking" class="details2-link ">
                                    <div class="txt1" id="toalPrice" > Rs {{$room->adult_price}} <span> TOTAL</span>
                                    </div>
                                    <div class="txt2">RESERVE THIS ROOM</div>
                                </a>
                                </div>
...
function fun(){
    ...
    document.getElementById('toalPrice').innerHTML = "Rs "+ totalprice +" <span> TOTAL</span>";
            ...
            function RoomBooking (){
                ...
                if(sessionStorage.getItem('CustomerName') != 'CustomerName' && sessionStorage.getItem('CustomerName')!= null)
                {
                    ...
                    $.ajax({
                    type:'POST',
                    url:"{{ route('CustomerRoomBooking.post') }}",
                    data: {
                    ...
                    success:function(data){
                        alert(sessionStorage.getItem('CustomerName') + ' Your Room Booking Success ')
                        
                        
                        window.location.href = "{{ route('CustomerRoomBooking.get',Session::get('CustomerId') ) }}";
